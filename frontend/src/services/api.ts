...
export const chatAPI = {
  ...
  sendMessage: (sessionId: string, content: string) =>
    api.post<{ userMessage: Message; assistantMessage: Message }>(
...
export const themenpaketeAPI = {
  ...
  start: (id: string) => api.post(`/themenpakete/${id}/start`),
  ...
  getNextUnit: (id: string) => api.get(`/themenpakete/${id}/next-unit`),

  advance: (id: string) => api.post(`/themenpakete/${id}/advance`),
};
