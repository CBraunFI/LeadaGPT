...
router.post('/seed', async (req: Request, res: Response) => {
  try {
    const themenpakete = [
      ...
      {
        title: 'Emotionale Intelligenz stärken',
        description: 'Entwickeln Sie Ihre emotionale Intelligenz als Führungskraft. Selbstwahrnehmung, Empathie und soziale Kompetenz.',
        category: 'Persönlichkeitsentwicklung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        ...
        description: 'Lernen Sie, auch bei unvollständigen Informationen kluge Entscheidungen zu treffen und Risiken einzuschätzen.',
        category: 'Entscheidungsfindung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Teamentwicklung & Teamdynamik',
        description: 'Formen Sie Ihr Team zu einer Hochleistungseinheit. Phasen der Teamentwicklung und praktische Interventionen.',
        category: 'Teamführung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Diversity & Inklusion fördern',
        description: 'Schaffen Sie eine inklusive Arbeitskultur, in der Vielfalt als Stärke geschätzt wird.',
        category: 'Unternehmenskultur',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Coaching-Gespräche führen',
        description: 'Entwickeln Sie Ihre Mitarbeiter durch professionelle Coaching-Gespräche und kraftvolle Fragen.',
        category: 'Mitarbeiterentwicklung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Meetings effektiv gestalten',
        description: 'Verwandeln Sie Meetings von Zeitfressern in produktive Zusammenkünfte mit klaren Ergebnissen.',
        category: 'Produktivität',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Generationenübergreifend führen',
        description: 'Führen Sie erfolgreich über Generationen hinweg - von Baby Boomern bis Gen Z.',
        category: 'Teamführung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Innovationskultur schaffen',
        description: 'Fördern Sie Kreativität und Innovation in Ihrem Team. Von der Idee zur Umsetzung.',
        category: 'Innovation',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        ...
        description: 'Erkennen Sie Warnsignale früh und schaffen Sie ein gesundes Arbeitsumfeld für sich und Ihr Team.',
        category: 'Gesundheit & Wohlbefinden',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Selbstführung & Selbstreflexion',
        description: 'Führen Sie sich selbst, bevor Sie andere führen. Reflektierte Führung beginnt bei Ihnen.',
        category: 'Persönlichkeitsentwicklung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Verhandlungsführung meistern',
        description: 'Verhandeln Sie überzeugend und erreichen Sie Win-Win-Ergebnisse in schwierigen Situationen.',
        category: 'Kommunikation',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Talente erkennen & fördern',
        description: 'Identifizieren Sie High Potentials und fördern Sie deren Entwicklung strategisch.',
        category: 'Mitarbeiterentwicklung',
        duration: 14,
        unitsPerDay: 2,
      },
      {
        title: 'Führen in der Krise',
        description: 'Bewahren Sie Ruhe und Klarheit in Krisenzeiten. Krisenmanagement für Führungskräfte.',
